...
const DockviewWrapper = (_props: Record<string, never>, scope: Record<string, any>) => {
	...
	Object.defineProperty(scope, 'api', {
		...
		set(api: DockviewApi) {
			...
			dock.api = api
			console.log('[DockviewWrapper] API assigned', { panelCount: api.panels.length })
